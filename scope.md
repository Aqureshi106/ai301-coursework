...
I am building my first contribution in a Python-heavy stack, and I prefer
issues that are small, concrete, and easy to verify with tests or a clear
repro. I want to avoid design-heavy or policy-heavy work and prefer tasks
where the expected fix is local and the acceptance criteria are explicit.
